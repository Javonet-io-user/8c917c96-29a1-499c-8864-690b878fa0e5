...
public class IACONTROLLERCONF extends ValueType {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Byte getDBType() {
    try {
      java.lang.Byte res = javonetHandle.get("DBType");
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setDBType(java.lang.Byte param) {
    try {
      javonetHandle.set("DBType", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public IACONTROLLERCONF(NObject handle) {
    super(handle);
