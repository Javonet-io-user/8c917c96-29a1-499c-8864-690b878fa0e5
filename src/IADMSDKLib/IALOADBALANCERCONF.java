...
public class IALOADBALANCERCONF extends ValueType {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Byte[] getVirtualIP(Class<?> returnArrayType) {
    try {
      Object[] res = javonetHandle.<NObject[]>get("VirtualIP");
      if (res == null) return null;
      return (java.lang.Byte[])
          JavonetHelper.ConvertNObjectToDestinationType((Object) res, returnArrayType);
    } catch (JavonetException _javonetException) {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setVirtualIP(java.lang.Byte[] param) {
    try {
      javonetHandle.set("VirtualIP", new Object[] {param});
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public IALOADBALANCERCONF(NObject handle) {
    super(handle);
